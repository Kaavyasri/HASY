...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2023 at 08:19 AM
...
CREATE TABLE `his_appointment` (
  ...
  `apt_phoneno` varchar(20) NOT NULL,
  `apt_time` varchar(200) NOT NULL,
  `apt_sub` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `his_appointment`
--

INSERT INTO `his_appointment` (`apt_id`, `apt_name`, `apt_email`, `apt_phoneno`, `apt_time`, `apt_sub`) VALUES
(5, 'Andrew', ' eg@mail.com', '9600694083', '12:30PM', ' neea an appointment to dr maran'),
(6, 'Kaavya sri E', ' elangovankaavyasri@gmail.com', '1234567890', '10:00 AM', ' Hello Dr HASY need to checkup'),
(7, 'siva', ' sivadsolo@gmail.com', '8760274063', '12.60pm', ' hi'),
(10, '', ' ', '', '', ' '),
(11, '', ' ', '', '', ' '),
(12, '', ' ', '', '', ' ');
...
CREATE TABLE `his_login` (
  ...
  `doc_pwd` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `doc_number` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `doc_id` int(20) NOT NULL,
  `doc_fname` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `doc_lname` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `doc_email` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `doc_dept` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `doc_dpic` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
INSERT INTO `his_login` (`ad_id`, `username`, `password`, `Is_admin`, `doc_pwd`, `doc_number`, `doc_id`, `doc_fname`, `doc_lname`, `doc_email`, `doc_dept`, `doc_dpic`, `ad_dpic`, `ad_lname`, `ad_fname`) VALUES
(1, 'admin@mail.com', '$2y$10$cLihb7tkolUXmKD1V/Oni.hdgKB4RvH3D.BK1dzEJ46bQSounE.K.', 1, '', '', 0, '', '', '', '', '', '', '', ''),
(4, 'YDS7L', '$2y$10$imU34ArjadWt2uFmf/hm.O/vzQUZXCxux2c9WStZm6YapPSuKBhke', 0, '55c3b5386c486feb662a0785f340938f518d547f', '1234', 6, 'Bryan', 'Arreola', 'bryan@mail.com', 'Surgery | Theatre', 'user-default-2-min.png', 'doc-icon.png', 'Administrator', 'System'),
(8, 'siva', '$2y$10$B6Apf/K5z8AWcvZb6asmZud21qTu8lk9NyWG0xzB7xOyd0tp88e4G', 0, '', '', 0, '', '', '', '', '', '', '', '');
...
(5, '493LR', 'Helen Macdougall', '28 Holly Street', '42', 'Test Test', 'KU8W4', NULL, '2023-03-18 10:27:59.9706');

-- --------------------------------------------------------

--
-- Table structure for table `his_mobile_pat1`
--

CREATE TABLE `his_mobile_pat1` (
...
(123, 'white', 'helen', '01/20/2020', '42', '61cf', ' Hill Haven Drive', '14782158', 'InPatient', '0000-00-00 00:00:00.000000', 'Test Test', NULL);
...
--
-- Table structure for table `his_report`
--
...
CREATE TABLE `his_report` (
  ...
  `pat_name` varchar(200) NOT NULL,
  `pat_rec` varchar(200) NOT NULL,
  `pat_lab_tst` varchar(200) NOT NULL,
  `pat_rpt` varchar(200) NOT NULL,
  `pat_date_rec` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `his_report`
--

INSERT INTO `his_report` (`pat_id`, `pat_number`, `pat_name`, `pat_rec`, `pat_lab_tst`, `pat_rpt`, `pat_date_rec`) VALUES
(8, 'DCRI8', 'Michael White', 'Malaria', '<p><strong>Pain areas: </strong>in the abdomen or muscles</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating</p><p><strong>Gastrointestinal: </strong>diarr', '<p><strong>Pain areas: </strong>in the abdomen or muscles -Tested Positive</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating - Tested Positive</p><p><stro', '2020-01-13 07:01:48'),
(9, 'ISL1E', 'Lawrence Bischof', 'Fever', '<ul><li>Body temperature</li><li>Blood</li><li>Stool</li><li>Urine</li></ul>', '<ul><li>Body Temperature 67 Degree Celcious(Abnormal)</li><li>Blood - Malaria Bacterial Tested Postive</li><li>Stool - Mucus tested postive</li><li>Urine -Urea Level were 20% higher than normal</li></', '2020-01-12 08:11:07'),
(10, '3Z14K', 'Cynthia Connolly', 'Demo Test', '<p>demo demo demo demo</p>', '<p>54545</p>', '2022-10-20 12:18:05'),
(11, 'KU8W4', 'Helen Macdougall', 'Malaria', '<p><strong>Pain areas: </strong>in the abdomen or muscles</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating</p><p><strong>Gastrointestinal: </strong>diarr', '<p><strong>Pain areas: </strong>in the abdomen or muscles -Tested Positive</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating - Tested Positive</p><p><stro', '2020-01-13 07:01:48'),
(12, '4TLG0', 'Christine Moore', 'Demo Test', '<ol><li>Test One</li><li>Test Two</li><li>Test Three</li><li>Test Four</li><li>Test Five</li></ol>', '<ol><li>Result One</li><li>Result Two</li><li>Result Three</li></ol>', '2022-10-22 05:31:11'),
(123, '61cf', 'white helen', 'Flu', '<ul><li><a href=\"https://www.medicalnewstoday.com/articles/179211.php\">Non-steroidal anti-inflammatory drugs</a> (NSAIDs) such as <a href=\"https://www.medicalnewstoday.com/articles/161255.php\">aspirin', '<ul><li>If the fever has been caused by a bacterial infection, the doctor may prescribe an <a href=\"https://www.medicalnewstoday.com/articles/10278.php\">antibiotic</a>.</li><li>If a fever has been cau', '2020-01-12 08:02:07');
...
(2, '3OY0M', 'Test', 'asdasd', NULL, 'asdasd@asd', '1234', '');
...
INSERT INTO `hospital` (`hos_id`, `name`, `address`, `email`, `phone`, `hcc_dpic`) VALUES
(1, '1', 'trichy', 'HCCTrz@mail.com', '1234567890', 'user-default-2-min.png');
...
INSERT INTO `locations` (`id`, `hospital_id`, `address`, `latitude`, `longitude`) VALUES
(1, 2, 'Chittorgarh, Rajasthan, India', '24.87999900', '74.62999700'),
(4, 23, 'Nanjangud, Mysore, Karnataka', '12.12000000', '76.68000000');
...
--
-- Indexes for table `his_mobile_pat1`
--
ALTER TABLE `his_mobile_pat1`
...
--
-- Indexes for table `his_report`
--
ALTER TABLE `his_report`
  ADD PRIMARY KEY (`pat_id`);
...
--
-- Indexes for table `hospital_diagnostics`
--
ALTER TABLE `hospital_diagnostics`
  ADD PRIMARY KEY (`hospital_id`,`diagnostic_id`),
...
--
-- AUTO_INCREMENT for table `his_mobile_pat1`
--
ALTER TABLE `his_mobile_pat1`
...
--
ALTER TABLE `his_patients`
  MODIFY `pat_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
-- AUTO_INCREMENT for table `his_report`
--
ALTER TABLE `his_report`
  MODIFY `pat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
-- Constraints for table `hospital_diagnostics`
--
ALTER TABLE `hospital_diagnostics`
  ADD CONSTRAINT `hospital_diagnostics_ibfk_1` FOREIGN KEY (`hospital_id`) REFERENCES `hospitals` (`hospital_id`),
  ADD CONSTRAINT `hospital_diagnostics_ibfk_2` FOREIGN KEY (`diagnostic_id`) REFERENCES `diagnostics` (`diagnostic_id`);

--
-- Constraints for table `hospital_doctors`
--
ALTER TABLE `hospital_doctors`
  ADD CONSTRAINT `hospital_doctors_ibfk_1` FOREIGN KEY (`hospital_id`) REFERENCES `hospitals` (`hospital_id`),
  ADD CONSTRAINT `hospital_doctors_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`doctor_id`);

--
-- Constraints for table `hospital_treatments`
--
ALTER TABLE `hospital_treatments`
  ADD CONSTRAINT `hospital_treatments_ibfk_1` FOREIGN KEY (`hospital_id`) REFERENCES `hospitals` (`hospital_id`),
  ADD CONSTRAINT `hospital_treatments_ibfk_2` FOREIGN KEY (`treatment_id`) REFERENCES `treatments` (`treatment_id`);
COMMIT;
