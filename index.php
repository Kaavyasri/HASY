...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="backend/admin/assets/images/logo.png" type="image/x-icon">
            ...
            <div class="container">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li><a href="backend/hos/index.php">Health-Care Centres Login</a></li>
                        <li><a href="backend/admin/index.php">District Health Offcials Login</a></li>
                    </ul>
